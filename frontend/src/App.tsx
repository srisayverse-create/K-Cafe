    ...
    <nav className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-700 ${isScrolled ? 'top-0' : 'top-4 lg:top-8'}`} role="navigation">
      <div className="max-w-[1600px] mx-auto px-4 lg:px-6 relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
             <a href="#home" className="flex items-center gap-4 group" aria-label="Kumbakonam Cafe Home">
               <CafeLogo size="sm" className="group-hover:scale-110 transition-transform text-brand" />
               <div className="flex flex-col items-center sm:items-start leading-none pointer-events-none">
                 <span className="font-brand font-black text-xl md:text-3xl tracking-tight text-cafe-dark dark:text-dark-text transition-colors">KUMBAKONAM</span>
                 <span className="text-[7px] md:text-[8px] font-black tracking-[0.6em] text-brand -mt-1 opacity-100 italic">CAFE</span>
               </div>
             </a>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:flex items-center gap-4">
                <button 
                  ...
                  className="px-8 py-3 bg-[#fff628] text-black text-[10px] font-black uppercase tracking-[0.3em] rounded-full hover:bg-white transition-all active:scale-95 shadow-glow"
                >
                  Order Now
                </button>
            </div>
               ...
               <div className="space-y-12">
                  ...
                  <div className="space-y-8 max-w-lg">
                    <div className="space-y-3">
                      <label className="text-[#3a7c3a] font-black text-[15px] block">Select City</label>
                      <div className="relative">
                        <select className="w-full p-4 lg:p-5 rounded-xl border border-gray-200 bg-white text-gray-400 appearance-none outline-none focus:border-brand transition-colors text-lg">
                    ...
                    <div className="space-y-3">
                      <label className="text-[#3a7c3a] font-black text-[15px] block">Select your location</label>
                      <div className="relative">
                        <select className="w-full p-4 lg:p-5 rounded-xl border border-gray-200 bg-white text-gray-400 appearance-none outline-none focus:border-brand transition-colors text-lg">
                          <option>Select your location</option>
                          <option>Musaffah</option>
                          <option>Khalidiyah</option>
                          <option>Hamdan</option>
                          <option>Shabiya</option>
                        </select>
                        <ChevronDown className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-300 pointer-events-none" size={20} />
                      </div>
                    </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <img 
            ...
            alt="Kumbakonam Cafe Storefront"
          />
