...
export const MENU_DATA: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Ghee Podi Thatte Idly", image: "/Assets/Thatte Idly and Dosa/Ghee pool podi thatte idly (3) (3).jpg" },
...
export const BRANCHES = [
  ...
  },
  {
    ...
    qrImage: "/Branches/Shabiya/QR - Shabiya11 Location.png",
    feedbackQrImage: "/Branches/Shabiya/QR -Feedback- Shabiya11.png",
